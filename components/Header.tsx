              ...
              <div className="flex items-center space-x-2">
                <div className="relative">
                  <div className="w-8 h-8 bg-gradient-to-br from-accent to-secondary rounded-lg flex items-center justify-center glitch-hover">
                    <span className="text-black font-bold text-sm font-mono">YN</span>
                  </div>
                ...
                <span className="glitch-text text-xl font-bold text-foreground group-hover:text-accent transition-colors" data-text="Your Name">
                  Your Name
                </span>
              </div>
            </Link>
